...
sql_to_s3_order_items = SqlToS3Operator(
    ...
    s3_key=bucket_subfolder + "order-items2-" + str(current_date) + ".csv",
    replace=True,
...
sql_to_s3_order_payments = SqlToS3Operator(
    ...
    s3_bucket=bucket_name,
    s3_key=bucket_subfolder + "order-payments2-" + str(current_date) + ".csv",
    replace=True,
    sql_conn_id=rdsmysql_conn,
    aws_conn_id=aws_conn,
    file_format='csv',
...
sql_to_s3_orders = SqlToS3Operator(
    ...
    s3_bucket=bucket_name,
    s3_key=bucket_subfolder + "orders2-" + str(current_date) + ".csv",
    replace=True,
    sql_conn_id=rdsmysql_conn,
    aws_conn_id=aws_conn,
    file_format='csv',
